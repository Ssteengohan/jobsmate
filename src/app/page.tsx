  ...
  return (
    <main className="mx-auto min-h-screen overflow-hidden bg-white transition-colors duration-300 dark:bg-[var(--neutral-50)]">
      ...
      <div className="relative container">
        ...
        <Spotlight
          className="-top-20 -left-10 sm:-top-30 z-20 sm:left-0 md:-top-96 md:left-1/3"
          fill="rgba(59, 130, 246, 0.15)"
          darkModeFill="rgba(58, 168, 236, 0.25)"
        />

        <Spotlight
          className="-top-10 -right-10 sm:top-0 sm:right-1/4 z-20 md:top-0 2xl:top-60 md:right-1/4 2xl:right-2/6"
